...
>>>>>>> 538d699b5f127129f2bd8ea9717032529d5933b9
    ...
    Verdadero.El operador sí quiere limitar los tipos de dispositivos que se pueden vincular, ya qué un teléfono solamente puede tener un único plan.
    ...
    Sí, ya que la participación entre teléfono y plan es parcial, entonces puede haber un teléfono sin plan, por lo que es posible mantener los datos relativos a un teléfono sin un plan.
